    ...
    $.ajax({
      ...
      $(".add-member").click(function () {
        ...
        try {
          ...
          // Assuming that you have already populated the #rd_modal_details select element as mentioned in your code
          // Attach an event listener to handle the change event of the select element
          setTimeout(() => {
            // Get the selected value from the select element
            var selectedValue = $("#rd_modal_details").val();
                ...
                for (var k = 0; k < building.departments.length; k++) {
                  ...
                  for (var l = 0; l < department.teams.length; l++) {
                    ...
                    if (team.item_id === selectedValue) {
                      ...
                      return; // Exit the loops since we found the team
                    }
                  }
                }
              }
        ...
        let memberblock = ` <div class="action cust" id="dIcon" style="display: flex; justify-content: right; margin-top:-15px; ">
        ...
        <div class="member-block" style="display: flex; flex-direction: column; align-items: center; position: relative;">
                                  <!-- Rows for Dropdowns -->
                                  <div class="row" style="margin-bottom: 5px; width: 100%;">
                                      ...
                                      <div class="col-12 col-sm-6 col-md-4">
                                          <div class="form-group">
                                              <select name="" class="form-select form-control os-select" id="operatingSystem" style="width: 100%; max-width: 100%;">
                                                  ${oshtml}
                                              </select>
                                          </div>
                                      </div>
